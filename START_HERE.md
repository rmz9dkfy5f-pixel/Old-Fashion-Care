...
## v3.2 Sub-Agent Layer

This project may include Claude Code sub-agents in `.claude/agents/`.

Use them to keep the main coding session focused:
...
Do not use every agent for every task. Use the smallest set needed.
